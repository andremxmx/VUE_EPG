...
declare const _default: {
    new (...args: any[]): {
        ...
        $props: Partial<{}> & Omit<Readonly<import("vue").ExtractPropTypes<__VLS_TypePropsToRuntimeProps<{
            ...
            onClick?: ((v: ProgramType) => any) | undefined;
        ...
        $emit: (event: "click", v: ProgramType) => void;
        $el: any;
    ...
    $slots: {
        program: (_: {
            theme: import("../helpers/interfaces").Theme;
            position: Omit<import("../helpers/types").Position, "edgeEnd">;
            data: ProgramType;
